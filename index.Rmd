...
service_box <- div(
  ...
  div(
    ...
    h4("Programming support and training (we're a trusted", a(href = "https://www.rstudio.com/instructors", target = "_blank", "RStudio instructor"), ")")
  ),
  div(
...
carousel_praise <- bs_carousel(id = "carousel-o-praise") %>%
  #bs_append(
  #  content = bs_carousel_image(src = "img/praise-1.svg")
  #) %>%
  #bs_append(
  #  content = bs_carousel_image(src = "img/praise-2.svg")
  #) %>%
  bs_append(
    content = bs_carousel_image(src = "img/praise.svg")
  ) %>%
  bs_append(
    content = bs_carousel_image(src = "img/praise-3.svg")
  ) %>%
  bs_append(
    content = bs_carousel_image(src = "img/praise-4.svg")
  )
