...
div(
  style = "display: flex; flex-wrap: wrap; height: 100%",
  div(
    
    style = "width: 25%; padding: 1em;",
    h1("Breathing life into data"),
    h4("At Sievert Consulting, we turn data into insight. We specialize in interactive data visualization, but offer a wide variety of services surrounding the practice, infrastructure, and dissemination of data science.")
  ),
