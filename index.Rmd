...
carousel_graphics <- bs_carousel(id = "carousel-o-graphics") %>%
...
content <- div(
  ...
  div(
    style = "width: 25%; padding: 1em; height: 625px",
  ...
  div(style = "width: 75%; padding: 1em; height: 625px", carousel_graphics),
  div(
    id = "Services",
  ...
  div(
    ...
    style = "width: 100%; padding: 1em",
    h1("Clients"),
    div(align = "center", h3("Our clients include: startups, government, universities, and corporations")),
    client_images
  ),
  div(
    id = "Praise",
  ...
  #   div(
  #     align = "center",
  #     h3("A gallery of Sievert Consulting examples."),
  #     "Coming soon"
  #   )
  # ),
  div(
    ...
    div(
      style = "display: flex; flex-wrap: wrap; justify-content: center;",
      div(style = "width: 25%; padding: 1em", img(src = "img/carson.jpg")),
      div(
        style = "width: 75%; padding: 1em", 
