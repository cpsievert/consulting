...
div(
  ...
  div(
    ...
    h2("Breathing life into data"),
    h4("At Sievert Consulting, we turn data into insight, and have expertise on creating interactive web graphics for both exploration and presentation.")
  ),
