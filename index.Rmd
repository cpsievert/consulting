...
welcome_carousel <- bs_carousel(id = "carousel-o-graphics") %>%
  ...
  bs_append(
    ...
    caption = bs_carousel_caption(
      "Figure 1: Zooming, hovering, and highlighting on a population map of Europe."
    )
  ) %>%
  bs_append(
    content = bs_carousel_image(src = "img/zikar-colombia.gif"),
    caption = bs_carousel_caption(
      "Figure 2: Comparing overall frequency of Zika virus cases (black) versus frequency within the map (red)."
    )
  ) %>%
  bs_append(
    content = bs_carousel_image(src = "img/pedestrians-missing.gif"),
    caption = bs_carousel_caption(
      "Figure 3: Comparing foot traffic in various train stations among those with highest number of missing values."
    )
  ) %>%
  ...
  bs_append(
    ...
    caption = bs_carousel_caption(
      "Figure 4: Exploring relationship between earthquake magnitude and geographic location"
    )
  ) %>%
  bs_append(
    content = bs_carousel_image(src = "img/tour.gif"),
    caption = bs_carousel_caption(
      "Figure 5: Choosing 3 groups of 'similar' US states (via Euclidean distance of arrest data). The rotating graph (aka, a grand tour) cycles through 2D projections of the data -- allowing us to assess how the clustering appears from many different perspectives."
    )
  )
...
service_box <- div(
  ...
  div(
    ...
    h4(a(href = "https://cran.r-project.org/", target = "_blank", "R"),  " & ", a(href = "https://www.rstudio.com", target = "_blank", "RStudio"), "development, support, and ", a(href="https://cpsievert.me/workshopz/", target = "_blank", "workshops"))
  ),
  div(
...
about <- div(
  ...
  div(
    id = "about-box",
    style = "display: flex; flex-wrap: wrap; justify-content: center;",
    div(id = "about-pic", a(href = "https://cpsievert.me/", target = "_blank", img(src = "img/carson.jpg"))),
    div(
      id = "about-txt",
...
tagList(
  tagline(
    ...
    "At Sievert Consulting, we turn data into insight. Our expertise is interactive data visualization, but offer numerous services surrounding the practice and dissemination of data science."
  ),
  welcome_carousel,
  tagline(
    "Services",
  ...
  tagline(
    "Praise",
    "Some nice things our clients, end-users, and audience members have said:"
  ),
  carousel_praise,
  tagline("About"),
  about,
...
tags$footer(
  div(
    ...
    div(style = "display:inline-block; margin:auto", "Copyright 2017 Sievert Consulting"),
    div(
